...
```html
<input type="text" value="2021-05-15 21:05" id="datetimepicker">
```
```javascript
...
```html
<input type="text" value="2021-05-15 21:05" id="datetimepicker" data-date-format="yyyy-mm-dd hh:ii">
```
```javascript
$('#datetimepicker').datetimepicker();
```
...
```html
<div class="input-append date" id="datetimepicker" data-date="12-02-2021" data-date-format="dd-mm-yyyy">
...
```html
<div class="input-append date" id="datetimepicker" data-date="12-02-2021" data-date-format="dd-mm-yyyy">
    <input class="span2" size="16" type="text" value="12-02-2021">
    <span class="add-on"><i class="icon-th"></i></span>
</div>
```
...
```javascript
$('#datetimepicker').datetimepicker('setStartDate', '2021-01-01');
```
...
```javascript
$('#datetimepicker').datetimepicker('setEndDate', '2021-12-31');
```
