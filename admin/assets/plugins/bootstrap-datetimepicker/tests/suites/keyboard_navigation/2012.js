module('Keyboard Navigation 2021', {
    setup: function(){
        /*
...
test('by day (right/left arrows)', function(){
    ...
    datesEqual(this.dp.viewDate, UTCDate(2021, 2, 30));
    datesEqual(this.dp.date, UTCDate(2021, 2, 30));
    // Month not changed
    target = this.picker.find('.datetimepicker-days thead th.switch');
    equal(target.text(), 'March 2021', 'Title is "March 2021"');
    ...
    datesEqual(this.dp.viewDate, UTCDate(2021, 3, 1));
    datesEqual(this.dp.date, UTCDate(2021, 3, 1));
    // Month changed: April 1 (this is not a joke!)
    target = this.picker.find('.datetimepicker-days thead th.switch');
    equal(target.text(), 'April 2021', 'Title is "April 2021"');
});
...
test('by week (up/down arrows)', function(){
    ...
    // Both updated on keyboard navigation
    datesEqual(this.dp.viewDate, UTCDate(2021, 2, 24));
    datesEqual(this.dp.date, UTCDate(2021, 2, 24));
    // Month not changed
    target = this.picker.find('.datetimepicker-days thead th.switch');
    equal(target.text(), 'March 2021', 'Title is "March 2021"');
    ...
    datesEqual(this.dp.viewDate, UTCDate(2021, 3, 7));
    datesEqual(this.dp.date, UTCDate(2021, 3, 7));
    target = this.picker.find('.datetimepicker-days thead th.switch');
    equal(target.text(), 'April 2021', 'Title is "April 2021"');
});
...
test('by month, v1 (shift + left/right arrows)', function(){
    ...
    datesEqual(this.dp.date, UTCDate(2021, 1, 29));
    // Month not changed
    target = this.picker.find('.datetimepicker-days thead th.switch');
    equal(target.text(), 'February 2021', 'Title is "February 2021"');
    ...
    datesEqual(this.dp.date, UTCDate(2021, 3, 29));
    target = this.picker.find('.datetimepicker-days thead th.switch');
    equal(target.text(), 'April 2021', 'Title is "April 2021"');
});
...
test('by year, from leap day', function(){
    ...
    this.input.val('29-02-2021').datetimepicker('update');
    datesEqual(this.dp.viewDate, UTCDate(2021, 1, 29));
    datesEqual(this.dp.date, UTCDate(2021, 1, 29));
    equal(target.text(), 'February 2021', 'Title is "February 2021"');
    ...
    // Both updated on keyboard navigation; graceful month-end
    datesEqual(this.dp.viewDate, UTCDate(2021, 1, 28));
    datesEqual(this.dp.date, UTCDate(2021, 1, 28));
    target = this.picker.find('.datetimepicker-days thead th.switch');
    equal(target.text(), 'February 2021', 'Title is "February 2021"');
