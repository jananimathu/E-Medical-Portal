...
test('Navigating prev/next in year view', function(){
    ...
    ok(this.picker.find('.datetimepicker-months').is(':visible'), 'Month picker is visible');
    equal(this.dp.viewMode, 3);
    equal(this.picker.find('.datetimepicker-months thead th.switch').text(), '2021');
    // Not modified when switching modes
    datesEqual(this.dp.viewDate, UTCDate(2021, 2, 31));
    datesEqual(this.dp.date, UTCDate(2021, 2, 31));
...
test('Selecting date from previous month resets viewDate and date, changing month displayed', function(){
    ...
    equal(this.picker.find('.datetimepicker-days thead th.switch').text(), 'March 2021');

    // Updated internally on click
    target.click();
    equal(this.picker.find('.datetimepicker-days thead th.switch').text(), 'February 2021');
...
test('Selecting date from next month resets viewDate and date, changing month displayed', function(){
    ...
    equal(this.picker.find('.datetimepicker-days thead th.switch').text(), 'April 2021');

    // Updated internally on click
    target.click();
    equal(this.picker.find('.datetimepicker-days thead th.switch').text(), 'May 2021');
