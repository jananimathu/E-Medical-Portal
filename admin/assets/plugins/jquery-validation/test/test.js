...
test("Min date set by attribute", function() {
	...
	equal( label.text(), "Please enter a value greater than or equal to 2021-12-21.", "Correct error label" );
});
...
test("Max date set by attribute", function() {
	...
	equal( label.text(), "Please enter a value less than or equal to 2021-12-21.", "Correct error label" );
});
...
test("Min and Max date set by attributes less", function() {
	...
	var label = $('#ranges label');
	equal( label.text(), "Please enter a value greater than or equal to 2021-11-21.", "Correct error label" );
});
