...
```html
<input type="text" value="02-16-2021" class="datepicker">
```
```javascript
...
```html
<div class="input-append date datepicker" data-date="12-02-2021" data-date-format="dd-mm-yyyy">
    <input size="16" type="text" value="12-02-2021" readonly><span class="add-on"><i class="icon-th"></i></span>
</div>
```
```javascript
$('.datepicker').datepicker();
...
<table class="table">
    <thead>
        <tr>
          <th>
              Start date
              <a href="#" class="btn small" id="date-start" data-date-format="yyyy-mm-dd" data-date="2021-02-20">Change</a>
          </th>
          <th>
              End date
              <a href="#" class="btn small" id="date-end" data-date-format="yyyy-mm-dd" data-date="2021-02-25">Change</a>
          </th>
        </tr>
    </thead>
    <tbody>
        <tr>
          <td id="date-start-display">2021-02-20</td>
          <td id="date-end-display">2021-02-25</td>
        </tr>
    </tbody>
</table>
```
```javascript
var startDate = new Date(2021,1,20);
var endDate = new Date(2021,1,25);
$('#date-start')
    .datepicker()
...
```html
<div class="input-append date datepicker" data-date="12-02-2021" data-date-format="dd-mm-yyyy">
    <input class="span2" size="16" type="text" value="12-02-2021"><span class="add-on"><i class="icon-th"></i></span>
</div>
```
...
<div class="input-daterange" id="datepicker">
    <input class="input-small" name="start" value="2021-04-05" />
    <span class="add-on">to</span>
    <input class="input-small" name="end" value="2021-04-07" />
</div>
```
...
```javascript
$('.datepicker').datepicker('setStartDate', '2021-01-01');
```
...
```javascript
$('.datepicker').datepicker('setEndDate', '2021-12-31');
```
