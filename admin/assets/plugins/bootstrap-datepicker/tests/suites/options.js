...
test('Autoclose', function(){
    ...
    datesEqual(dp.date, UTCDate(2021, 2, 4));
    datesEqual(dp.viewDate, UTCDate(2021, 2, 4));
});
...
test('Today Button: moves to today\'s date', function(){
    var input = $('<input />')
        ...
        datesEqual(dp.date, UTCDate(2021, 2, 5));
});
...
test('Today Highlight: today\'s date is not highlighted by default', patch_date(function(Date){
    ...
    var input = $('<input />')
        ...
        input.focus();
        ok(picker.find('.datepicker-days').is(':visible'), 'Days view visible');
        equal(picker.find('.datepicker-days thead .datepicker-switch').text(), 'March 2021', 'Title is "March 2021"');
...
test('BeforeShowDay', function(){
    ...
    var beforeShowDay = function(date) {
        ...
        var dateTime25th = UTCDate(2021, 9, 25).getTime();
        var dateTime26th = UTCDate(2021, 9, 26).getTime();
        var dateTime27th = UTCDate(2021, 9, 27).getTime();
        var dateTime28th = UTCDate(2021, 9, 28).getTime();
