...
exports["lang:ms-my"] = {
    ...
    "weeks year starting sunday" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).week(), 1, "Jan  1 2021 sepatutnya minggu 1");
        test.equal(moment([2021, 0,  7]).week(), 2, "Jan  7 2021 sepatutnya minggu 2");
        test.equal(moment([2021, 0,  8]).week(), 2, "Jan  8 2021 sepatutnya minggu 2");
        test.equal(moment([2021, 0, 14]).week(), 3, "Jan 14 2021 sepatutnya minggu 3");
        test.equal(moment([2021, 0, 15]).week(), 3, "Jan 15 2021 sepatutnya minggu 3");
    ...
    "weeks year starting sunday format" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).format('w ww wo'), '1 01 1', "Jan  1 2021 sepatutnya minggu 1");
        test.equal(moment([2021, 0,  7]).format('w ww wo'), '2 02 2', "Jan  7 2021 sepatutnya minggu 2");
        test.equal(moment([2021, 0,  8]).format('w ww wo'), '2 02 2', "Jan  8 2021 sepatutnya minggu 2");
        test.equal(moment([2021, 0, 14]).format('w ww wo'), '3 03 3', "Jan 14 2021 sepatutnya minggu 3");
        test.equal(moment([2021, 0, 15]).format('w ww wo'), '3 03 3', "Jan 15 2021 sepatutnya minggu 3");
