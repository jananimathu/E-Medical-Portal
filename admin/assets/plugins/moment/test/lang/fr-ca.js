...
exports["lang:fr-ca"] = {
    ...
    "weeks year starting sunday format" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).format('w ww wo'), '1 01 1er', "Jan  1 2021 should be week 1");
        test.equal(moment([2021, 0,  7]).format('w ww wo'), '1 01 1er', "Jan  7 2021 should be week 1");
