...
exports["lang:gl"] = {
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021,  0,  1]).format('w ww wo'), '1 01 1º', "Jan  1 2021 should be week 1");
        test.equal(moment([2021,  0,  2]).format('w ww wo'), '2 02 2º', "Jan  2 2021 should be week 2");
        test.equal(moment([2021,  0,  8]).format('w ww wo'), '2 02 2º', "Jan  8 2021 should be week 2");
        test.equal(moment([2021,  0,  9]).format('w ww wo'), '3 03 3º', "Jan  9 2021 should be week 3");
