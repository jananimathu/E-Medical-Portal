...
exports["lang:fa"] = {
    ...
    "weeks year starting sunday" : function (test) {
        ...
        test.equal(moment([2021,  0,  6]).week(), 1, "Jan  6 2021 should be week 1");
        test.equal(moment([2021,  0,  7]).week(), 2, "Jan  7 2021 should be week 2");
        test.equal(moment([2021,  0, 13]).week(), 2, "Jan 13 2021 should be week 2");
        test.equal(moment([2021,  0, 14]).week(), 3, "Jan 14 2021 should be week 3");
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021,  0,  6]).format('w ww wo'), '۱ ۰۱ ۱م', "Jan  6 2021 should be week 1");
        test.equal(moment([2021,  0,  7]).format('w ww wo'), '۲ ۰۲ ۲م', "Jan  7 2021 should be week 2");
        test.equal(moment([2021,  0, 13]).format('w ww wo'), '۲ ۰۲ ۲م', "Jan 13 2021 should be week 2");
        test.equal(moment([2021,  0, 14]).format('w ww wo'), '۳ ۰۳ ۳م', "Jan 14 2021 should be week 3");
