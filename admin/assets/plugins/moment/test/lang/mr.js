...
exports["lang:mr"] = {
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021, 0,  7]).format('w ww wo'), '१ ०१ १', "Jan  7 2021 should be week 1");
        test.equal(moment([2021, 0,  8]).format('w ww wo'), '२ ०२ २', "Jan  8 2021 should be week 2");
        test.equal(moment([2021, 0, 14]).format('w ww wo'), '२ ०२ २', "Jan 14 2021 should be week 2");
        test.equal(moment([2021, 0, 15]).format('w ww wo'), '३ ०३ ३', "Jan 15 2021 should be week 3");
