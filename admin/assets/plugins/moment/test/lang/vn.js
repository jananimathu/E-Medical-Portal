...
exports["lang:vn"] = {
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021, 0,  2]).format('w ww wo'),   '1 01 1', "Jan  2 2021 should be week 1");
        test.equal(moment([2021, 0,  8]).format('w ww wo'),   '1 01 1', "Jan  8 2021 should be week 1");
