...
exports["lang:kr"] = {
    ...
    "weeks year starting sunday format" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).format('w ww wo'), '1 01 1일', "Jan  1 2021 should be week 1");
        test.equal(moment([2021, 0,  7]).format('w ww wo'), '1 01 1일', "Jan  7 2021 should be week 1");
        test.equal(moment([2021, 0,  8]).format('w ww wo'), '2 02 2일', "Jan  8 2021 should be week 2");
        test.equal(moment([2021, 0, 14]).format('w ww wo'), '2 02 2일', "Jan 14 2021 should be week 2");
        test.equal(moment([2021, 0, 15]).format('w ww wo'), '3 03 3일', "Jan 15 2021 should be week 3");
