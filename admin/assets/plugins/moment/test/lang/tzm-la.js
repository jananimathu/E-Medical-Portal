...
exports["lang:tzm-la"] = {
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021,  0,  6]).format('w ww wo'), '1 01 1', "Jan  6 2021 should be week 1");
        test.equal(moment([2021,  0,  7]).format('w ww wo'), '2 02 2', "Jan  7 2021 should be week 2");
        test.equal(moment([2021,  0, 13]).format('w ww wo'), '2 02 2', "Jan 13 2021 should be week 2");
        test.equal(moment([2021,  0, 14]).format('w ww wo'), '3 03 3', "Jan 14 2021 should be week 3");
