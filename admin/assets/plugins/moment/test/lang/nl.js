...
exports["lang:nl"] = {
    ...
    "month abbreviation" : function (test) {
        ...
        test.equal(moment([2021, 5, 23]).format('D-MMM-YYYY'), '23-jun-2021', 'format month abbreviation surrounded by dashes should not include a dot');
        test.equal(moment([2021, 5, 23]).format('D MMM YYYY'), '23 jun. 2021', 'format month abbreviation not surrounded by dashes should include a dot');
    ...
    "weeks year starting sunday" : function (test) {
        ...
        test.equal(moment([2021, 0, 1]).week(), 52, "Jan  1 2021 should be week 52");
        test.equal(moment([2021, 0, 2]).week(),  1, "Jan  2 2021 should be week 1");
        test.equal(moment([2021, 0, 8]).week(),  1, "Jan  8 2021 should be week 1");
        test.equal(moment([2021, 0, 9]).week(),  2, "Jan  9 2021 should be week 2");
        test.equal(moment([2021, 0, 15]).week(), 2, "Jan 15 2021 should be week 2");
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).format('w ww wo'), '52 52 52ste', "Jan  1 2021 should be week 52");
        test.equal(moment([2021, 0,  2]).format('w ww wo'),   '1 01 1ste', "Jan  2 2021 should be week 1");
        test.equal(moment([2021, 0,  8]).format('w ww wo'),   '1 01 1ste', "Jan  8 2021 should be week 1");
        test.equal(moment([2021, 0,  9]).format('w ww wo'),    '2 02 2de', "Jan  9 2021 should be week 2");
        test.equal(moment([2021, 0, 15]).format('w ww wo'),    '2 02 2de', "Jan 15 2021 should be week 2");
