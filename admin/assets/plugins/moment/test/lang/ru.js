...
exports["lang:ru"] = {
    ...
    "format meridiem" : function (test) {
        ...
        test.equal(moment([2021, 11, 28, 0, 0]).format("A"), "ночи", "night");
        test.equal(moment([2021, 11, 28, 3, 59]).format("A"), "ночи", "night");
        test.equal(moment([2021, 11, 28, 4, 0]).format("A"), "утра", "morning");
        test.equal(moment([2021, 11, 28, 11, 59]).format("A"), "утра", "morning");
        test.equal(moment([2021, 11, 28, 12, 0]).format("A"), "дня", "afternoon");
        test.equal(moment([2021, 11, 28, 16, 59]).format("A"), "дня", "afternoon");
        test.equal(moment([2021, 11, 28, 17, 0]).format("A"), "вечера", "evening");
        test.equal(moment([2021, 11, 28, 23, 59]).format("A"), "вечера", "evening");
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021,  0,  1]).format('w ww wo'), '1 01 1-я', "Jan  1 2021 should be week 1");
        test.equal(moment([2021,  0,  2]).format('w ww wo'), '2 02 2-я', "Jan  2 2021 should be week 2");
        test.equal(moment([2021,  0,  8]).format('w ww wo'), '2 02 2-я', "Jan  8 2021 should be week 2");
        test.equal(moment([2021,  0,  9]).format('w ww wo'), '3 03 3-я', "Jan  9 2021 should be week 3");
