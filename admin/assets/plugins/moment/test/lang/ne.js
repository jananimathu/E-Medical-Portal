...
exports["lang:ne"] = {
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021,  0,  1]).format('w ww wo'), '१ ०१ १', "Jan  1 2021 should be week 1");
        test.equal(moment([2021,  0,  2]).format('w ww wo'), '२ ०२ २', "Jan  2 2021 should be week 2");
        test.equal(moment([2021,  0,  8]).format('w ww wo'), '२ ०२ २', "Jan  8 2021 should be week 2");
        test.equal(moment([2021,  0,  9]).format('w ww wo'), '३ ०३ ३', "Jan  9 2021 should be week 3");
