...
exports["lang:tr"] = {
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021,  0,  1]).format('w ww wo'), "1 01 1'inci", "Jan  1 2021 should be week 1");
        test.equal(moment([2021,  0,  2]).format('w ww wo'), "2 02 2'nci", "Jan  2 2021 should be week 2");
        test.equal(moment([2021,  0,  8]).format('w ww wo'), "2 02 2'nci", "Jan  8 2021 should be week 2");
        test.equal(moment([2021,  0,  9]).format('w ww wo'), "3 03 3'üncü", "Jan  9 2021 should be week 3");
