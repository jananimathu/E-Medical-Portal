...
exports["lang:ka"] = {
    ...
    "weeks year starting sunday" : function (test) {
        ...
        test.equal(moment([2021,  0,  1]).week(), 1, "იან  1 2021 უნდა იყოს კვირა 1");
        test.equal(moment([2021,  0,  2]).week(), 2, "იან  2 2021 უნდა იყოს კვირა 2");
        test.equal(moment([2021,  0,  8]).week(), 2, "იან  8 2021 უნდა იყოს კვირა 2");
        test.equal(moment([2021,  0,  9]).week(), 3, "იან  9 2021 უნდა იყოს კვირა 3");
    ...
    "weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021,  0,  1]).format('w ww wo'), '1 01 1-ლი', "იან  1 2021 უნდა იყოს კვირა 1");
        test.equal(moment([2021,  0,  2]).format('w ww wo'), '2 02 მე-2', "იან  2 2021 უნდა იყოს კვირა 2");
        test.equal(moment([2021,  0,  8]).format('w ww wo'), '2 02 მე-2', "იან  8 2021 უნდა იყოს კვირა 2");
        test.equal(moment([2021,  0,  9]).format('w ww wo'), '3 03 მე-3', "იან  9 2021 უნდა იყოს კვირა 3");
