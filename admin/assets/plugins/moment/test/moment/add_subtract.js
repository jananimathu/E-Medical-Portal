...
exports.add = {
    "add short" : function (test) {
        ...
        test.equal(a.add({y: 1}).year(), 2021, 'Add year');
    ...
    "add long" : function (test) {
        ...
        test.equal(a.add({years: 1}).year(), 2021, 'Add year');
        test.done();
    },
    ...
    "add long singular" : function (test) {
        ...
        test.equal(a.add({year: 1}).year(), 2021, 'Add year');
        test.done();
    },
    ...
    "add string long reverse args" : function (test) {
        ...
        test.equal(a.add(1, 'year', 1).year(), 2021, 'Add year');
        test.done();
    },
    ...
    "add string long singular reverse args" : function (test) {
        ...
        test.equal(a.add(1, 'years').year(), 2021, 'Add year');
        test.done();
    },
    ...
    "add string short reverse args" : function (test) {
        ...
        test.equal(a.add(1, 'y').year(), 2021, 'Add year');
        test.done();
    },
