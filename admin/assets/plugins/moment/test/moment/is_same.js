...
exports.is_same = {
    "is same without units" : function (test) {
        ...
        test.equal(m.isSame(moment(new Date(2021, 3, 2, 3, 5, 5, 10))), false, "year is later");
    ...
    "is same year" : function (test) {
        ...
        test.equal(m.isSame(moment(new Date(2021, 5, 6, 7, 8, 9, 10)), 'year'), false, "year mismatch");
        ...
        test.equal(m.isSame(moment(new Date(2021, 0, 1, 0, 0, 0, 0)), 'year'), false, "start of next year");
    ...
    "is same month" : function (test) {
        ...
        test.equal(m.isSame(moment(new Date(2021, 2, 6, 7, 8, 9, 10)), 'month'), false, "year mismatch");
    ...
    "is same day" : function (test) {
        ...
        test.equal(m.isSame(moment(new Date(2021, 1, 2, 7, 8, 9, 10)), 'day'), false, "year mismatch");
    ...
    "is same hour" : function (test) {
        ...
        test.equal(m.isSame(moment(new Date(2021, 1, 2, 3, 8, 9, 10)), 'hour'), false, "year mismatch");
    ...
    "is same minute" : function (test) {
        ...
        test.equal(m.isSame(moment(new Date(2021, 1, 2, 3, 4, 9, 10)), 'minute'), false, "year mismatch");
    ...
    "is same second" : function (test) {
        ...
        test.equal(m.isSame(moment(new Date(2021, 1, 2, 3, 4, 5, 10)), 'second'), false, "year mismatch");
    ...
    "is same millisecond" : function (test) {
        ...
        test.equal(m.isSame(moment(new Date(2021, 3, 2, 3, 4, 5, 10)), 'millisecond'), false, "year is later");
