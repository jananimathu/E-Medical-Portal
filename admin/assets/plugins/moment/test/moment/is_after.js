...
exports.is_after = {
    "is after without units" : function (test) {
        ...
        test.equal(m.isAfter(moment(new Date(2021, 3, 2, 3, 5, 5, 10))), false, "year is later");
    ...
    "is after year" : function (test) {
        ...
        test.equal(m.isAfter(moment(new Date(2021, 0, 1, 0, 0, 0, 0)), 'year'), false, "start of next year");
    ...
    "is after month" : function (test) {
        ...
        test.equal(m.isAfter(moment(new Date(2021, 2, 6, 7, 8, 9, 10)), 'month'), false, "year is later");
    ...
    "is after day" : function (test) {
        ...
        test.equal(m.isAfter(moment(new Date(2021, 3, 2, 7, 8, 9, 10)), 'day'), false, "year is later");
    ...
    "is after hour" : function (test) {
        ...
        test.equal(m.isAfter(moment(new Date(2021, 3, 2, 3, 8, 9, 10)), 'hour'), false, "year is later");
    ...
    "is after minute" : function (test) {
        ...
        test.equal(m.isAfter(moment(new Date(2021, 3, 2, 3, 4, 9, 10)), 'minute'), false, "year is later");
    ...
    "is after second" : function (test) {
        ...
        test.equal(m.isAfter(moment(new Date(2021, 3, 2, 3, 4, 5, 10)), 'second'), false, "year is later");
    ...
    "is after millisecond" : function (test) {
        ...
        test.equal(m.isAfter(moment(new Date(2021, 3, 2, 3, 4, 5, 10)), 'millisecond'), false, "year is later");
