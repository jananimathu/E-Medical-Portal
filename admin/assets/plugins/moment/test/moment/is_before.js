...
exports.is_before = {
    "is after without units" : function (test) {
        ...
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 3, 5, 5, 10))), true, "year is later");
    ...
    "is before year" : function (test) {
        ...
        test.equal(m.isBefore(moment(new Date(2021, 5, 6, 7, 8, 9, 10)), 'years'), true, "plural should work");
        ...
        test.equal(m.isBefore(moment(new Date(2021, 0, 1, 0, 0, 0, 0)), 'year'), true, "start of next year");
    ...
    "is before month" : function (test) {
        ...
        test.equal(m.isBefore(moment(new Date(2021, 2, 6, 7, 8, 9, 10)), 'months'), true, "plural should work");
        test.equal(m.isBefore(moment(new Date(2021, 2, 6, 7, 8, 9, 10)), 'month'), true, "year is later");
    ...
    "is before day" : function (test) {
        ...
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 7, 8, 9, 10)), 'days'), true, "plural should work");
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 7, 8, 9, 10)), 'day'), true, "year is later");
    ...
    "is before hour" : function (test) {
        ...
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 3, 8, 9, 10)), 'hours'), true, "plural should work");
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 3, 8, 9, 10)), 'hour'), true, "year is later");
    ...
    "is before minute" : function (test) {
        ...
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 3, 4, 9, 10)), 'minutes'), true, "plural should work");
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 3, 4, 9, 10)), 'minute'), true, "year is later");
    ...
    "is before second" : function (test) {
        ...
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 3, 4, 5, 10)), 'seconds'), true, "plural should work");
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 3, 4, 5, 10)), 'second'), true, "year is later");
    ...
    "is before millisecond" : function (test) {
        ...
        test.equal(m.isBefore(moment(new Date(2021, 3, 2, 3, 4, 5, 10)), 'millisecond'), true, "year is later");
