...
exports.is_valid = {
    ...
    "string + formats bad date" : function (test) {
        ...
        test.equal(moment('12-13-2021', ['DD-MM-YYYY', 'YYYY-MM-DD']).isValid(), false, 'month rollover');
        test.equal(moment('12-13-2021', ['DD-MM-YYYY', 'DD-MM-YYYY']).isValid(), false, 'month rollover');
        test.equal(moment('38-12-2021', ['DD-MM-YYYY']).isValid(), false, 'day rollover');
    ...
    "string with bad month name" : function (test) {
        ...
        test.equal(moment('01-Nam-2021', 'DD-MMM-YYYY').isValid(), false, '"Nam" is an invalid month');
        test.equal(moment('01-Aug-2021', 'DD-MMM-YYYY').isValid(), true, '"Aug" is a valid month');
