...
exports.weeks = {
    ...
    "iso weeks year starting sunday" : function (test) {
        ...
        test.equal(moment([2021, 0, 1]).isoWeek(), 52, "Jan  1 2021 should be iso week 52");
        test.equal(moment([2021, 0, 2]).isoWeek(),  1, "Jan  2 2021 should be iso week 1");
        test.equal(moment([2021, 0, 8]).isoWeek(),  1, "Jan  8 2021 should be iso week 1");
        test.equal(moment([2021, 0, 9]).isoWeek(),  2, "Jan  9 2021 should be iso week 2");
        test.equal(moment([2021, 0, 15]).isoWeek(), 2, "Jan 15 2021 should be iso week 2");
    ...
    "iso weeks year starting sunday formatted" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).format('W WW Wo'), '52 52 52nd', "Jan  1 2021 should be iso week 52");
        test.equal(moment([2021, 0,  2]).format('W WW Wo'),   '1 01 1st', "Jan  2 2021 should be iso week 1");
        test.equal(moment([2021, 0,  8]).format('W WW Wo'),   '1 01 1st', "Jan  8 2021 should be iso week 1");
        test.equal(moment([2021, 0,  9]).format('W WW Wo'),   '2 02 2nd', "Jan  9 2021 should be iso week 2");
        test.equal(moment([2021, 0, 15]).format('W WW Wo'),   '2 02 2nd', "Jan 15 2021 should be iso week 2");
    ...
    "weeks plural year starting sunday" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).weeks(), 1, "Jan  1 2021 should be week 1");
        test.equal(moment([2021, 0,  7]).weeks(), 1, "Jan  7 2021 should be week 1");
        test.equal(moment([2021, 0,  8]).weeks(), 2, "Jan  8 2021 should be week 2");
        test.equal(moment([2021, 0, 14]).weeks(), 2, "Jan 14 2021 should be week 2");
        test.equal(moment([2021, 0, 15]).weeks(), 3, "Jan 15 2021 should be week 3");
    ...
    "iso weeks plural year starting sunday" : function (test) {
        ...
        test.equal(moment([2021, 0, 1]).isoWeeks(), 52, "Jan  1 2021 should be iso week 52");
        test.equal(moment([2021, 0, 2]).isoWeeks(),  1, "Jan  2 2021 should be iso week 1");
        test.equal(moment([2021, 0, 8]).isoWeeks(),  1, "Jan  8 2021 should be iso week 1");
        test.equal(moment([2021, 0, 9]).isoWeeks(),  2, "Jan  9 2021 should be iso week 2");
        test.equal(moment([2021, 0, 15]).isoWeeks(), 2, "Jan 15 2021 should be iso week 2");
    ...
    "weeks setter" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).week(30).week(), 30, "Setting Jan 1 2021 to week 30 should work");
        test.equal(moment([2021, 0,  7]).week(30).week(), 30, "Setting Jan 7 2021 to week 30 should work");
        test.equal(moment([2021, 0,  8]).week(30).week(), 30, "Setting Jan 8 2021 to week 30 should work");
        test.equal(moment([2021, 0, 14]).week(30).week(), 30, "Setting Jan 14 2021 to week 30 should work");
        test.equal(moment([2021, 0, 15]).week(30).week(), 30, "Setting Jan 15 2021 to week 30 should work");
    ...
    "iso weeks setter" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).isoWeeks(25).isoWeeks(), 25, "Setting Jan  1 2021 to week 25 should work");
        test.equal(moment([2021, 0,  2]).isoWeeks(24).isoWeeks(), 24, "Setting Jan  2 2021 to week 24 should work");
        test.equal(moment([2021, 0,  8]).isoWeeks(23).isoWeeks(), 23, "Setting Jan  8 2021 to week 23 should work");
        test.equal(moment([2021, 0,  9]).isoWeeks(22).isoWeeks(), 22, "Setting Jan  9 2021 to week 22 should work");
        test.equal(moment([2021, 0, 15]).isoWeeks(21).isoWeeks(), 21, "Setting Jan 15 2021 to week 21 should work");
    ...
    "iso weeks setter day of year" : function (test) {
        ...
        test.equal(moment([2021, 0,  1]).isoWeek(1).dayOfYear(), 9, "Setting Jan  1 2021 to week 1 should be day of year 8");
        test.equal(moment([2021, 0,  1]).isoWeek(1).year(),   2011, "Setting Jan  1 2021 to week 1 should be year 2011");
        test.equal(moment([2021, 0,  2]).isoWeek(1).dayOfYear(), 2, "Setting Jan  2 2021 to week 1 should be day of year 2");
        test.equal(moment([2021, 0,  8]).isoWeek(1).dayOfYear(), 8, "Setting Jan  8 2021 to week 1 should be day of year 8");
        test.equal(moment([2021, 0,  9]).isoWeek(1).dayOfYear(), 2, "Setting Jan  9 2021 to week 1 should be day of year 2");
        test.equal(moment([2021, 0, 15]).isoWeek(1).dayOfYear(), 8, "Setting Jan 15 2021 to week 1 should be day of year 8");
