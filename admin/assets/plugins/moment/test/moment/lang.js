...
exports.lang = {
    ...
    "library ensure inheritance" : function (test) {
        ...
        test.equal(moment([2021, 5, 6]).format('MMMM'), 'July', 'Override some of the configs');
        test.equal(moment([2021, 5, 6]).format('MMM'), 'Jun', 'But not all of them');
    ...
    "instance lang method" : function (test) {
        ...
        test.equal(moment([2021, 5, 6]).format('MMMM'), 'June', 'Normally default to global');
        test.equal(moment([2021, 5, 6]).lang('es').format('MMMM'), 'junio', 'Use the instance specific language');
        test.equal(moment([2021, 5, 6]).format('MMMM'), 'June', 'Using an instance specific language does not affect other moments');
    ...
    "instance lang persists with manipulation" : function (test) {
        ...
        test.equal(moment([2021, 5, 6]).lang('es').add({days: 1}).format('MMMM'), 'junio', 'With addition');
        test.equal(moment([2021, 5, 6]).lang('es').day(0).format('MMMM'), 'junio', 'With day getter');
        test.equal(moment([2021, 5, 6]).lang('es').endOf('day').format('MMMM'), 'junio', 'With endOf');
    ...
    "meridiem parsing" : function (test) {
        ...
        moment.lang('meridiem-parsing');
        test.equal(moment('2021-01-01 3b', 'YYYY-MM-DD ha').hour(), 15, 'Custom parsing of meridiem should work');
        test.equal(moment('2021-01-01 3d', 'YYYY-MM-DD ha').hour(), 3, 'Custom parsing of meridiem should work');
