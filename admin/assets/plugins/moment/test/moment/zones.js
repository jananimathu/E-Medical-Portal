...
exports.zones = {
    ...
    "getters and setters" : function (test) {
        ...
        test.equal(a.clone().zone(120).year(2021).year(), 2021, "should get and set year correctly");
    ...
    "getters" : function (test) {
        var a = moment.utc([2021, 0, 1, 0, 0, 0]);
        ...
        test.equal(a.clone().zone(-120).year(),  2021, "should get year correctly");
        ...
        test.equal(a.clone().zone(-90).year(),  2021, "should get year correctly");
    ...
    "reset zone with moment#utc" : function (test) {
        var a = moment.utc([2021]).zone(480);
