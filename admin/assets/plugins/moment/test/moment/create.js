...
exports.create = {
    ...
    "string with format dropped am/pm bug" : function (test) {
        ...
        test.equal(moment('05/1/2021', 'MM/DD/YYYY h:m:s a').format('MM/DD/YYYY'), '05/01/2021', 'should not break if am/pm is left off from the parsing tokens');
        test.equal(moment('05/1/2021 12:25:00 am', 'MM/DD/YYYY h:m:s a').format('MM/DD/YYYY'), '05/01/2021', 'should not break if am/pm is left off from the parsing tokens');
        test.equal(moment('05/1/2021 12:25:00 pm', 'MM/DD/YYYY h:m:s a').format('MM/DD/YYYY'), '05/01/2021', 'should not break if am/pm is left off from the parsing tokens');
    ...
    "matching am/pm" : function (test) {
        ...
        test.equal(moment('2021-09-03T03:00PM',   'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00PM', 'am/pm should parse correctly for PM');
        test.equal(moment('2021-09-03T03:00P.M.', 'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00PM', 'am/pm should parse correctly for P.M.');
        test.equal(moment('2021-09-03T03:00P',    'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00PM', 'am/pm should parse correctly for P');
        test.equal(moment('2021-09-03T03:00pm',   'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00PM', 'am/pm should parse correctly for pm');
        test.equal(moment('2021-09-03T03:00p.m.', 'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00PM', 'am/pm should parse correctly for p.m.');
        test.equal(moment('2021-09-03T03:00p',    'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00PM', 'am/pm should parse correctly for p');

        test.equal(moment('2021-09-03T03:00AM',   'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00AM', 'am/pm should parse correctly for AM');
        test.equal(moment('2021-09-03T03:00A.M.', 'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00AM', 'am/pm should parse correctly for A.M.');
        test.equal(moment('2021-09-03T03:00A',    'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00AM', 'am/pm should parse correctly for A');
        test.equal(moment('2021-09-03T03:00am',   'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00AM', 'am/pm should parse correctly for am');
        test.equal(moment('2021-09-03T03:00a.m.', 'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00AM', 'am/pm should parse correctly for a.m.');
        test.equal(moment('2021-09-03T03:00a',    'YYYY-MM-DDThh:mmA').format('YYYY-MM-DDThh:mmA'), '2021-09-03T03:00AM', 'am/pm should parse correctly for a');

        test.equal(moment('5:00p.m.March 4 2021', 'h:mmAMMMM D YYYY').format('YYYY-MM-DDThh:mmA'), '2021-03-04T05:00PM', 'am/pm should parse correctly before month names');
    ...
    "string with format (timezone offset)" : function (test) {
        ...
        e = moment.utc('Fri, 20 Jul 2021 17:15:00', 'ddd, DD MMM YYYY HH:mm:ss');
        f = moment.utc('Fri, 20 Jul 2021 10:15:00 -0700', 'ddd, DD MMM YYYY HH:mm:ss ZZ');
    ...
    "strict parsing" : function (test) {
        test.expect(10);
        test.equal(moment("2021-05", "YYYY-MM", true).format("YYYY-MM"), "2021-05", "parse correct string");
        test.equal(moment(" 2021-05", "YYYY-MM", true).isValid(), false, "fail on extra whitespace");
        test.equal(moment("foo 2021-05", "[foo] YYYY-MM", true).format('YYYY-MM'), "2021-05", "handle fixed text");
        test.equal(moment("2021 05", "YYYY-MM", true).isValid(), false, "fail on different separator");
    ...
    "parsing into a language" : function (test) {
        ...
        test.equal(moment('2021 seven', 'YYYY MMM', 'parselang').month(), 6, "should be able to parse in a specific language");

        moment.lang('parselang');

        test.equal(moment('2021 july', 'YYYY MMM', 'en').month(), 6, "should be able to parse in a specific language");
